...
CREATE INDEX idx_mcp_tool_call_queries_tool_call_id ON mcp_tool_call_queries USING btree (mcp_tool_call_id);
CREATE INDEX idx_mcp_tool_calls_conversation_id ON mcp_tool_calls USING btree (conversation_id);
CREATE INDEX idx_mcp_tool_calls_created_at ON mcp_tool_calls USING btree (created_at);
