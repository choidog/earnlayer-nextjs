-- Update agreement to version 2.0.0
-- First, deactivate all existing versions
UPDATE agreement_versions SET is_active = false WHERE is_active = true;
...
INSERT INTO agreement_versions (
    ...
    '2.0.0',
    '14c6059bb11c02ca57496726332b0d4d3c9d7fa7b6592471f372b7ddf82f315e',
...
You consent to do business electronically and to the use of electronic records. EarnLayer may maintain an electronic record of your acceptance, including account ID, timestamp, IP address, and the version of this Agreement accepted.',
    true,
    NOW(),
    'system',
    'Updated to comprehensive EarnLayer Publisher Agreement v2.0 with detailed revenue sharing, data rights, and legal terms'
);

-- Verify the update
SELECT version_string, is_active, effective_date FROM agreement_versions ORDER BY created_at DESC LIMIT 2;