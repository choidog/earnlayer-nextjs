...
ALTER TABLE public.advertisers ADD CONSTRAINT advertisers_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
